...
<table>
<tr>
<th align="center" width="450px" height="25px" bgcolor="#336699"><font face="arial" color="white" size="2"></font></th>
</tr>
<tr>
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="new7.php">View Information</a></td>
</tr>
</table>
<br>
<br>
...
$query="SELECT * FROM employees where user_id='{$ctrl}'";
...
?>
 ...
 <?php
  if(isset($_POST['update']))
  {
				...
				{
  $update = mysql_query("update employees set FNAME='$fname',mNAME='$mname', lname='$lname',level='$level', phone_no='$phone_no' 
