...
<table align="center" id="insides" width="850px"height="647px">
<tr>
...
<a href="admin.php" title="Close"><img src="img/close_icon.gif"></a></div> 
 ...
 $query="SELECT * FROM employees where username='$_POST[username]'";
...
{
$sql="INSERT INTO employees (FNAME,mNAME,lname,user_id,sex,level,phone_no,username ,password,confirmpassword,status)
VALUES
